...
var dictNeglectSum = c({
  ...
  cimap: function (f, g, x) {
    u.assert(arguments.length === 3, "cimap: there should be 3 arguments");
    u.assert(u.isFunction(f), "cimap: f should be a function");
    u.assert(u.isFunction(g), "cimap: g should be a function");
